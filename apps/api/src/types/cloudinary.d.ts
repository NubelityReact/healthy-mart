...
declare module "cloudinary" {
  ...
  export interface MetadataRuleResultEnableWithActivate
    extends MetadataRuleResultCommon {
    enable?: boolean;
    activate_values:
      | "all"
      | {
  ...
  export interface MetadataRuleResultEnableWithApply
    extends MetadataRuleResultCommon {
    enable?: boolean;
    apply_value: {
  ...
  export namespace v2 {
    ...
    namespace utils {
      ...
      function generate_transformation_string(
